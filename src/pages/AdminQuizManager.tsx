              ...
              {newQuestion.options.map((opt, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    className="flex-1 p-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-primary"
                    value={opt}
                    onChange={e => {
        ...
        <div className="space-y-4">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-4">
              {questions.map(q => (
                <div key={q.id} className="bg-white p-6 rounded-3xl card-shadow flex justify-between items-start group">
